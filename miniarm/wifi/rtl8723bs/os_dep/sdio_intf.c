...
static struct adapter *rtw_sdio_if1_init(struct dvobj_priv *dvobj, const struct sdio_device_id  *pdid)
{
	...
	DBG_871X_LEVEL(_drv_always_, "@rtw_sdio_if1_init.start\n");
...
exit:
	DBG_871X_LEVEL(_drv_always_, "@rtw_sdio_if1_init.return\n");
	return padapter;
}
	...
	const struct sdio_device_id *id)
{
	...
	DBG_871X_LEVEL(_drv_always_, "@rtw_drv_init.start\n");
...
exit:
	DBG_871X_LEVEL(_drv_always_, "@rtw_drv_init.return\n");
...
static void rtw_dev_remove(struct sdio_func *func)
{
	...
	DBG_871X_LEVEL(_drv_always_, "@rtw_dev_remove.start\n");
	...
	RT_TRACE(_module_hci_intfs_c_, _drv_notice_, ("-rtw_dev_remove\n"));
	DBG_871X_LEVEL(_drv_always_, "@rtw_dev_remove.return\n");
}
...
{
	int ret = 0;
	DBG_871X_LEVEL(_drv_always_, "@rtw_drv_entry.start\n");
...
exit:
	...
	DBG_871X_LEVEL(_drv_always_, "@rtw_drv_entry.return\n");
	return ret;
}
